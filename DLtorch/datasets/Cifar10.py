...
class Cifar10(base_dataset):
    ...
    def __init__(self, datadir, mean=None, std=None, train_transform=None, test_transform=None, whether_valid=False, portion=None):
        super(base_dataset, self).__init__(datatype="image", datadir=datadir, whether_valid=whether_valid)
        ...
        self.datasets["train"] = datasets.CIFAR10(root=self.datadir, train=True, download=True, transform=self.train_transform)
        self.datasets["test"] = datasets.CIFAR10(root=self.datadir, train=False, download=True, transform=self.test_transform)
